                                ...
                                <a href="https://mirafra.com/" className="card-link" target="_blank" rel="noopener noreferrer">
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title">Mirafra</h5>
                                            <p className="card-text">Revamped Mirafra's website to showcase a vast array of cutting-edge engineering solutions with an attractive, user-friendly design.
                                            </p>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div className="col-12 col-sm-6 col-md-6 col-lg-4 mt-4">
                                <a href="https://resil.com/" className="card-link" target="_blank" rel="noopener noreferrer">
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title">Resil</h5>
                                            <p className="card-text">Designed a corporate website for Resil, emphasizing sustainability and showcasing their varied approaches to highlight their key positioning statement.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div className="col-12 col-sm-6 col-md-6 col-lg-4 mt-4">
                                <a href="https://cordindia.in/" className="card-link" target="_blank" rel="noopener noreferrer">
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title">CORD</h5>
                                            <p className="card-text">Designed a 100+ page website for CORD, an NGO, with extensive use of client images, videos, and well-structured text to engage visitors.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div className="col-12 col-sm-6 col-md-6 col-lg-4 mt-4">
                                <a href="https://ekanaclub.com/" className="card-link" target="_blank" rel="noopener noreferrer">
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title">Ekana Club</h5>
                                            <p className="card-text">Developed a luxurious website for Lucknow’s Ekana Club, featuring an IPL cricket stadium and numerous sports facilities, clubs, and restaurants.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div className="col-12 col-sm-6 col-md-6 col-lg-4 mt-4">
                                <a href="https://quantumenergy.in/" className="card-link" target="_blank" rel="noopener noreferrer">
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title">Quantum Energy</h5>
                                            <p className="card-text">Launched a new website detailing Quantum Energy's electric scooters with specs, descriptions, pricing, and vibrant imagery.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div className="col-12 col-sm-6 col-md-6 col-lg-4 mt-4">
                                <a href="https://project-lithium.com/" className="card-link" target="_blank" rel="noopener noreferrer">
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title">Project Lithium</h5>
                                            <p className="card-text">Revamped an outdated website with stylish designs and clear messaging, showcasing Project Lithium's forward-thinking ethos.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div className="col-12 col-sm-6 col-md-6 col-lg-4 mt-4">
                                <a href="https://www.assetzproperty.com/bloomanddell/" className="card-link" target="_blank" rel="noopener noreferrer">
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title">Assetz Property</h5>
                                            <p className="card-text">Created a stylish, mobile-first website showcasing Assetz Property's premium Bloom &amp; Dell properties.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div className="col-12 col-sm-6 col-md-6 col-lg-4 mt-4">
                                <a href="https://techwisedigital.com/" className="card-link" target="_blank" rel="noopener noreferrer">
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title">Techwise</h5>
                                            <p className="card-text">Crafted a premium B2B website for Techwise, conveying their brand offerings with sophistication and clarity.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div className="col-12 col-sm-6 col-md-6 col-lg-4 mt-4">
                                <a href="https://hmconstructions.com/" className="card-link" target="_blank" rel="noopener noreferrer">
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title">HM Constructions</h5>
                                            <p className="card-text">HM Constructions is Bangalore's most trusted real estate development company.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                ...
                                <a href="https://www.peoplestrong.com/" className="card-link" target="_blank" rel="noopener noreferrer">
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <p className="card-text">Overhauled a complex 100+ page website with a robust visual language and a precise content strategy to highlight various solutions.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div className="col-12 col-sm-6 col-md-6 col-lg-4 mt-4">
                            <a href="#" className="card-link" target="_blank" rel="noopener noreferrer">
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                        <h5 className="card-title">Britannia AI campaign</h5>
                                        <p className="card-text">An AI website for the Chhoti Khushiyaan Campaign, allowing users to personalize and request any wish for their little moments of joy.
</p>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div className="col-12 col-sm-6 col-md-6 col-lg-4 mt-4">
                            <a href="#" className="card-link" target="_blank" rel="noopener noreferrer">
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                        <h5 className="card-title">Cowrks Diwali AI Campaign</h5>
                                        <p className="card-text">A Diwali AI campaign website where users can generate customized lanterns by selecting patterns, colors, and shapes.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
